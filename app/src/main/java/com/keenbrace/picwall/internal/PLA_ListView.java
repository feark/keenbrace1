...
package com.keenbrace.picwall.internal;
...
import com.keenbrace.picwall.DebugUtil;
...
public class PLA_ListView extends PLA_AbsListView {
    ...
    public PLA_ListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.PicWallListView, defStyle, 0);
        ...
        final Drawable osHeader = a.getDrawable(
                R.styleable.PicWallListView_overScrollHeader);
        if (osHeader != null) {
            setOverscrollHeader(osHeader);
        }

        final Drawable osFooter = a.getDrawable(
                R.styleable.PicWallListView_overScrollFooter);
        if (osFooter != null) {
        ...
        final int dividerHeight = a.getDimensionPixelSize(
                R.styleable.PicWallListView_dividerHeight, 0);
        if (dividerHeight != 0) {
            setDividerHeight(dividerHeight);
        }

        mHeaderDividersEnabled = a.getBoolean(R.styleable.PicWallListView_headerDividersEnabled, true);
        mFooterDividersEnabled = a.getBoolean(R.styleable.PicWallListView_footerDividersEnabled, true);

        if (a.hasValue(R.styleable.PicWallListView_plaContentBackground)) {
            int contentBackgroundColor = a.getColor(R.styleable.PicWallListView_plaContentBackground, 0);
