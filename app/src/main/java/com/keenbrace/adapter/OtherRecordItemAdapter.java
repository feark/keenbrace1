 ...
 */
public class OtherRecordItemAdapter extends ArrayAdapter<CommonResult> {
    ...
    public OtherRecordItemAdapter(Context context, int resource, List<CommonResult> objects) {
    ...
    public void setData(final ViewHolder CommonResult, final int position){
        final CommonResult item = CommonResult.getItemData();
        /*
